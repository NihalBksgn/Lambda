...
public class Lambda04 {
    ...
    */
    ...
    public static OptionalInt enBuyukOrtalama(List<Universite> unv) {
      return   unv.stream().filter(t->t.getOgrSayisi()>500).mapToInt(t->t.getNotOrt()).max();
    }

    //task 06-->Ogrenci sayilari 1050'dan az olan universite'lerin en kucuk notOrt'unu bulunuz.
    public static OptionalInt ogrSayisi1050denAzNotOrt(List<Universite> unv) {
